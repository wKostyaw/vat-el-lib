			...
			<div class="SiteWrapper">
				...
				<div class="bookPage">
					<div class="coverAndButtons">
						...
						<button class="bookButton">Что-то еще</button>
					</div>
					<div class="bookInfo">
						<p class="bookName">Название книги</p>
						<p class="bookInfoPoint"><b>Год:</b> значение</p>
						<p class="bookInfoPoint"><b>Автор(ы):</b> значение</p>
						<p class="bookInfoPoint"><b>Категория(и):</b> значение</p>
						<p class="bookInfoPoint"><b>Краткое описание:</b> значение значение значение значение значение значение значение значение значение значение значение значение значение значение значение значение значение значение значение</p>
					</div>
				</div>
				</div>
			</div>
